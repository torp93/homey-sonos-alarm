...
function describeRoom(alarms, language = 'en') {
  ...
  return list
    ...
    // Linjeskift, ikke punktum-separator. Fem alarmer pa en linje ble kuttet
    // etter den forste — det samme skiftet gjor lista i enhetsinnstillingene
    // lesbar, og der er den bevist a virke.
    .join('\n');
}
